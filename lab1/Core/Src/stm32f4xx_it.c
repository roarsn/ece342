...
/**
  ...
  */
void EXTI9_5_IRQHandler(void)// col 1-3
{
  // Your code here detect key press and inform which col to main
...
void EXTI15_10_IRQHandler(void)
{
  if (__HAL_GPIO_EXTI_GET_FLAG(USER_Btn_Pin)) {//redundant check to make sure button is pressed
    // Your code here
		HAL_GPIO_TogglePin(LD1_GPIO_Port, LD1_Pin); //is this the green one?
